...
public class MagicSquareMomo {
	public static void main(String[] args){
		int[][] ar;
		ar = new int[4][4];
		
		ar[0][0] = 1;ar[0][1] = 1;ar[0][2] = 1;ar[0][3] = 1;
		ar[1][0] = 1;ar[1][1] = 1;ar[1][2] = 1;ar[1][3] = 1;
		ar[2][0] = 1;ar[2][1] = 1;ar[2][2] = 1;ar[2][3] = 1;
		ar[3][0] = 1;ar[3][1] = 1;ar[3][2] = 1;ar[3][3] = 1;
